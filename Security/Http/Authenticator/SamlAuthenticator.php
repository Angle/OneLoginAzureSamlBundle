...
namespace Angle\OneLoginAzureSamlBundle\Security\Http\Authenticator;

use Angle\OneLoginAzureSamlBundle\Event\UserCreatedEvent;
use Angle\OneLoginAzureSamlBundle\Event\UserModifiedEvent;
use Angle\OneLoginAzureSamlBundle\Security\Http\Authenticator\Passport\Badge\SamlAttributesBadge;
use Angle\OneLoginAzureSamlBundle\Security\Http\Authenticator\Token\SamlToken;
