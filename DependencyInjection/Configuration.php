...
class Configuration implements ConfigurationInterface
{
    ...
    {
        $treeBuilder = new TreeBuilder('angle_one_login_azure_saml');
        $rootNode = $treeBuilder->getRootNode();

        /* Complete OneLogin configuration, for reference
        $rootNode
            ->children()
                ...
                ->arrayNode('security')
                    ->children()
                        ...
                        ->scalarNode('entityManagerName')
                            ->setDeprecated(
                                'angle/oneloginazuresaml-bundle',
                                '2.1',
                                'The "%path%.%node%" is deprecated. Use "angle_one_login_azure_saml.entityManagerName" instead.'
                            )
                        ->end()
                    ->end()
                ->end()
